...
const ROOT_FOLDER = 'https://drive.google.com/drive/folders/1SqHg8zyaIP84sNKOg61QBFUXTFmMIr6O';
const ARTIST = 'Bury Tomorrow'; // `const ARTIST = null` if not applicable
const SOURCE_NAME = 'Bury Tomorrow';
