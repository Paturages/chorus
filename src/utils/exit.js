...
module.exports = async () => {
  if (!process.argv[2]) {
    ...
    await Pg.q`ALTER TABLE IF EXISTS "Songs_Words" RENAME TO "Songs_Words_backup"`;
    ...
    await Pg.q`ALTER TABLE "Songs_Words_new" RENAME TO "Songs_Words"`;
    await Pg.q`ALTER TABLE "Songs_Sources_new" RENAME TO "Songs_Sources"`;
    await Pg.q`DELETE FROM "Songs_Words" WHERE "word" = ''`;
  }
  process.exit(0);
};
